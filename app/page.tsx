...
export default function LandingPage() {
  ...
  return (
    <div className="flex-grow flex flex-col bg-black text-white selection:bg-white selection:text-black">
      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex flex-col items-center text-center">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#111_1px,transparent_1px),linear-gradient(to_bottom,#111_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-80" />

        <div className="max-w-4xl mx-auto relative z-10 space-y-6">
          {/* Status Badge Pill */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-zinc-800 bg-zinc-950 text-zinc-400 text-[10px] font-bold uppercase tracking-widest">
          ...
          <form onSubmit={handleSearchSubmit} className="max-w-xl mx-auto pt-4">
            <div className="flex items-center gap-2 p-1 bg-zinc-950 border border-zinc-800 rounded-lg">
              ...
              <button
                type="submit"
                className="bg-white hover:bg-zinc-200 text-black text-[10px] font-bold uppercase tracking-widest px-4 py-2.5 rounded-md transition-colors"
              >
                Search
              </button>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link
              href="/login"
              className="w-full sm:w-auto border border-zinc-800 hover:border-zinc-700 text-white font-bold text-xs uppercase tracking-widest px-6 py-3 rounded text-center transition-colors"
            >
              View Documentation
            </Link>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Card 1 */}
          <div className="border border-zinc-800 bg-zinc-950/30 rounded-lg p-6 flex flex-col justify-between space-y-4">
            <div className="space-y-2">
              <div className="w-8 h-8 rounded border border-zinc-800 flex items-center justify-center text-zinc-400">
                <Shield className="w-4 h-4" />
              </div>
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">Cryptographic Security</h3>
          ...
          <div className="border border-zinc-800 bg-zinc-950/30 rounded-lg p-6 flex flex-col justify-between space-y-4">
            <div className="space-y-2">
              ...
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">Regulatory Compliance</h3>
              <p className="text-xs text-zinc-400 leading-relaxed font-light">
                Automated tax reporting and cross-border regulatory adherence built-in to facilitate global enterprise payments.
              </p>
            </div>
            <div className="p-3 bg-black border border-zinc-900 rounded font-mono text-[9px] text-zinc-500 flex justify-between items-center">
          ...
          <div className="border border-zinc-800 bg-zinc-950/30 rounded-lg p-6 flex flex-col justify-between space-y-4">
            <div className="space-y-2">
              ...
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">Neutral Arbitration</h3>
              <p className="text-xs text-zinc-400 leading-relaxed font-light">
          ...
          <div className="border border-zinc-800 bg-zinc-950/30 rounded-lg p-6 flex flex-col justify-between space-y-4">
            <div className="space-y-2">
              ...
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">Deterministic Workflows</h3>
              <p className="text-xs text-zinc-400 leading-relaxed font-light">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
        ...
        <div className="border border-zinc-800 bg-black rounded-lg overflow-hidden flex flex-col sm:flex-row h-72">
          {/* Left Mock Sidebar */}
          <div className="w-full sm:w-48 bg-zinc-950/50 border-b sm:border-b-0 sm:border-r border-zinc-900 p-4 space-y-2 shrink-0">
            ...
            <div className="px-3 py-1.5 text-xs font-semibold text-zinc-500 hover:text-white transition-colors">Pending Release</div>
            <div className="px-3 py-1.5 text-xs font-semibold text-zinc-500 hover:text-white transition-colors">Disputes</div>
          </div>

          {/* Right Mock Table */}
          <div className="flex-1 p-6 overflow-x-auto">
            <div className="text-[9px] font-mono text-zinc-600 mb-4">/escrow/active-contracts</div>
      ...
      <section className="py-20 border-t border-zinc-900 bg-zinc-950/20">
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="border border-zinc-850 p-8 rounded-lg flex flex-col justify-between space-y-6">
            <div>
          ...
          <div className="border border-zinc-850 p-8 rounded-lg flex flex-col justify-between space-y-6">
            <div>
              <h3 className="text-base font-bold text-white uppercase tracking-wider">Offer Enterprise Services</h3>
              <p className="text-xs text-zinc-400 leading-relaxed font-light mt-2">
            ...
            <Link
              href="/login"
              className="border border-zinc-800 hover:border-zinc-700 text-white font-bold text-xs uppercase tracking-widest py-3.5 rounded text-center transition-colors"
            >
              Join as Freelancer
            </Link>
          </div>
