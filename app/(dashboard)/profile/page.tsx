    ...
    <div className="space-y-8 w-full max-w-4xl mx-auto min-w-0 animate-fadeIn">
      ...
      <div>
        <div className="flex items-center gap-2 text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-widest mb-1">
          ...
          <span>&gt;</span>
          <span className="text-[var(--text-muted)] font-bold">Profile Settings</span>
        </div>
        <h1 className="text-2xl font-bold tracking-tight text-[var(--text-primary)] leading-tight">Profile Settings</h1>
      ...
      <div className="border border-[var(--border)] bg-[var(--surface)] rounded-lg p-6 sm:p-8 space-y-6 shadow-sm">
        {successMsg && (
          <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded text-xs text-emerald-700 dark:text-emerald-400 flex items-start gap-3 animate-fadeIn">
            <CheckCircle className="w-4 h-4 text-emerald-700 dark:text-emerald-400 mt-0.5 flex-shrink-0" />
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-left">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block">Display Name</label>
              <input
                type="text"
                value={name}
            ...
            {/* Phone */}
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block">Phone Number</label>
              <input
                type="text"
                value={phone}
            ...
            {/* Location */}
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block">Location</label>
              <input
                type="text"
                value={location}
            ...
            {/* Business Name */}
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block">Business Name</label>
              <input
                type="text"
                value={businessName}
          ...
          {/* Bio */}
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-wider block">Bio / Professional Summary</label>
            <textarea
              value={bio}
